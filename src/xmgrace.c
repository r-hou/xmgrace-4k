...
String fallbackResourcesHighRes[] = {
    "XMgrace*mainWin.width: 1560",
    "XMgrace*mainWin.height: 1400",
    "XMgrace*fontList:-*-helvetica-medium-r-normal-*-40-*-*-*-*-*-*-*",
    "XMgrace.consoleDialog*text.fontList:-*-courier-medium-r-normal-*-40-*-*-*-*-*-*-*",
...
String fallbackResourcesLowRes[] = {
    "XMgrace*mainWin.width: 1260",
    "XMgrace*mainWin.height: 1090",
    "XMgrace*fontList:-*-helvetica-medium-r-normal-*-40-*-*-*-*-*-*-*",
    "XMgrace.consoleDialog*text.fontList:-*-courier-medium-r-normal-*-40-*-*-*-*-*-*-*",
